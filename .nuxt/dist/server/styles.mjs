...
export default {
  "node_modules/nuxt/dist/app/entry.js": () => import('./_nuxt/entry-styles.DYAD2t0Q.mjs').then(interopDefault),
  ...
  "components/BannerSlide.vue": () => import('./_nuxt/BannerSlide-styles.CG0RgNgb.mjs').then(interopDefault),
